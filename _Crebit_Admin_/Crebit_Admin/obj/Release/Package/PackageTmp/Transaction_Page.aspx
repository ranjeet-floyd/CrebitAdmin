    ...
    <form id="Form1" runat="server">
        ...
        <div class="dashboard-middle">
            ...
            <div class="table-responsive">
                <table class="table table-striped" style="border: 1px solid black; width: 50%; margin-left: 25%; margin-right: 25%">
                    ...
                    <tr>
                        ...
                        <td>Rs.<%=pending_AmountCount %> </td>
                        <td>Rs.<%=InPro_AmountCount %></td>
                    </tr>
                    <tr>
                        <td style="background-color: #000; color: #fff;">MSEB</td>
                        <td>Rs.<%=success_ElecAmount%></td>
                        <td>Rs.<%= failed_ElecAmount%> </td>
                        <td>Rs.<%=pending_ElecAmount  %></td>
                        <td>Rs.<%=InPro_ElecAmount %></td>
                    </tr>
                    <tr>
                        <td class="TableColor">CrebitFund</td>
                        <td>Rs.<%=success_FundAmount%></td>
                        <td>Rs.<%= failed_FundAmount %></td>
                        <td>Rs.<%=pending_FundAmount %> </td>
                        <td>Rs. <%=InPro_FundAmount %></td>
                    </tr>
                    <tr>
                        <td style="background-color: #000; color: #fff;">MoneyTransfer</td>
                        <td>Rs.<%=success_MoneyTransferAmount%></td>
                        <td>Rs. <%=failed_MoneyTransferAmount %></td>
                        <td>Rs.<%=pending_MoneyTransferAmount %></td>
                        <td>Rs.<%=InPro_MoneyTransferAmount %></td>
                    </tr>
                    <tr>
                        <td class="TableColor">CyberPlate</td>
                        <td>Rs.<%=success_cyberPlate%></td>
                        <td>Rs. <%=failed_cyberPlate %></td>
                        <td>Rs.<%=pending_cyberPlate %> </td>
                        <td>Rs. <%=InPro_cyberPlate %></td>
                    </tr>
                </table>
            </div>
            ...
            <div id="Transaction-details" >
                <p id="Transaction" class="space">   </p>
