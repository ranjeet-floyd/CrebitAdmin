    ...
    <form runat="server">
        ...
        <div class="dashboard-middle">
            ...
            <div class="navbar-collapse collapse subData">
                <ul class="nav navbar-nav navbar-right margin5 ">
                    ...
                    <li>
                        <input type="text" class="form-control" id="TransactionID" placeholder="TransactionID" /></li>
                    <li>
        ...
        <div class="modal fade status_model_2" id="myModal_2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="H2">Success:</h4>
                        <span style="padding: 50px">
                            <asp:Label ID="Label1" Text="Msg" runat="server" /></span>
                    </div>
                    <div class="modal-header">
                        <h4 class="modal-title" id="ToggleTranId">TransactionId:</h4>
                        <span style="padding: 50px">
                            <asp:Label ID="TransId" Text="TransId" runat="server" />
                        </span>
                    </div>

                    <div class="modal-header">
                        <h4 class="modal-title" id="ToggleMsg">Message:</h4>
                        <span style="padding: 50px">
                            <asp:Label ID="Message" Text="Msg" runat="server" /></span>
                    </div>
...
<script>
    function getStatus() {
        ...
        var dataJSON = {};
        AjaxCall("GET", "http://crebit.in/dhs/cyberTransStatus/" + transId, dataJSON, getStatusCallBack);//call api
        return false;
    }
    //Ajax call for api
    ...
    function getStatusCallBack(resObj) {
        ...
        try {
            if (resObj != null & resObj != "") {
                ...
                if (resObj['status'] == "1") {
                    html = "<div class='alert alert-success'> Successfully recharged </div>"
                    
                }
                else {
                    html = "<div class='table-responsive'><table class='table table-striped' style='border: 1px solid black; '>"
                    //html += ' <tr> <td class="numeric text-center" data-title="TransactionId">' + resObj['transId'] + '</td>';
                    //html += '<td class="numeric" data-title="Message">' + resObj['message'] + '</td>';

                    html += "<tr><td style='background-color: #000;color:#fff; '>TransactionId</td><td>" + resObj['transId'] + "</td>"
                    html += "<tr><td style='background-color: #000;color:#fff; '>Message</td><td>" + resObj['message'] + "</td></tr></table></div>"
                }
            }
        }
        catch (ex) {
